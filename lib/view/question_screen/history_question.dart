...
import 'package:miniproject/utils/history_db.dart';
import 'package:miniproject/view/result_screen/historyresult.dart';

class HisQns extends StatefulWidget {
  const HisQns(BuildContext context, {super.key});

  @override
  State<HisQns> createState() => _HisQnsState();
}

class _HisQnsState extends State<HisQns> {
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: Text(
                '${questinindex + 1}/ ${HistoryDb.historydbquestions.length}',
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      HistoryDb.historydbquestions[questinindex]["question"],
                      style: TextStyle(
                ...
                ListView.separated(
                  ...
                  itemCount: HistoryDb
                      .historydbquestions[questinindex]["options"].length,
                      ...
                      onTap: () {
                        setState(() {
                          ...
                          if (selectedAnswerIndex != null &&
                              selectedAnswerIndex ==
                                  HistoryDb.historydbquestions[questinindex]
                                      ["answer"]) {
                            righAnswer++;
                          }
                        });
                ...
                InkWell(
                  onTap: () {
                    ...
                    persantage += 0.1;
                    if (questinindex <
                        HistoryDb.historydbquestions.length - 1) {
                      questinindex++;
  ...
  Color getRightAnswer(int index) {
    if (selectedAnswerIndex != null &&
        index == HistoryDb.historydbquestions[questinindex]["answer"]) {
      return ColorConstant.mycustomgreen;
    }
    if (selectedAnswerIndex == index) {
      if (selectedAnswerIndex ==
          HistoryDb.historydbquestions[questinindex]["answer"]) {
        return ColorConstant.mycustomgreen;
      } else {
