...
import 'package:miniproject/utils/sports_db.dart';
import 'package:miniproject/view/result_screen/sportsresult.dart';

class SportsQns extends StatefulWidget {
  const SportsQns(BuildContext context, {super.key});

  @override
  State<SportsQns> createState() => _SportsQnsState();
}

class _SportsQnsState extends State<SportsQns> {
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: Text(
                '${questinindex + 1}/ ${SportsDb.sportsdbquestions.length}',
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      SportsDb.sportsdbquestions[questinindex]["question"],
                      style: TextStyle(
                ...
                ListView.separated(
                  ...
                  itemCount: SportsDb
                      .sportsdbquestions[questinindex]["options"].length,
                      ...
                      onTap: () {
                        setState(() {
                          ...
                          if (selectedAnswerIndex != null &&
                              selectedAnswerIndex ==
                                  SportsDb.sportsdbquestions[questinindex]
                                      ["answer"]) {
                            righAnswer++;
                          }
                        });
  ...
  Color getRightAnswer(int index) {
    if (selectedAnswerIndex != null &&
        index == SportsDb.sportsdbquestions[questinindex]["answer"]) {
      return ColorConstant.mycustomgreen;
    }
    if (selectedAnswerIndex == index) {
      if (selectedAnswerIndex ==
          SportsDb.sportsdbquestions[questinindex]["answer"]) {
        return ColorConstant.mycustomgreen;
      } else {
