...
import 'package:miniproject/utils/chemistry_db.dart';
import 'package:miniproject/utils/color.dart';
import 'package:miniproject/view/result_screen/chemistryresult.dart';

class ChemQns extends StatefulWidget {
  const ChemQns(BuildContext context, {super.key});

  @override
  State<ChemQns> createState() => _ChemQnsState();
}

class _ChemQnsState extends State<ChemQns> {
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: Text(
                '${questinindex + 1}/ ${ChemistryDb.chemistrydbquestions.length}',
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ChemistryDb.chemistrydbquestions[questinindex]
                          ["question"],
                      style: TextStyle(
                ...
                ListView.separated(
                  ...
                  itemCount: ChemistryDb
                      .chemistrydbquestions[questinindex]["options"].length,
                ...
                InkWell(
                  onTap: () {
                    ...
                    persantage += 0.1;
                    if (questinindex <
                        ChemistryDb.chemistrydbquestions.length - 1) {
                      questinindex++;
  ...
  Color getRightAnswer(int index) {
    if (selectedAnswerIndex != null &&
        index == ChemistryDb.chemistrydbquestions[questinindex]["answer"]) {
      return ColorConstant.mycustomgreen;
    }
    if (selectedAnswerIndex == index) {
      if (selectedAnswerIndex ==
          ChemistryDb.chemistrydbquestions[questinindex]["answer"]) {
        return ColorConstant.mycustomgreen;
      } else {
